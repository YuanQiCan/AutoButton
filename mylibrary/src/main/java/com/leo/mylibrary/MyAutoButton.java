 ...
 */
public class MyAutoButton extends View implements View.OnTouchListener {
    ...
    public MyAutoButton(Context context) {
        this(context, null);
    }

    public MyAutoButton(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MyAutoButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MyAutoButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initData(Context context,AttributeSet attrs)
    {
        ...
        leftText = a.getString(R.styleable.AutoButton_leftText);
        rightText = a.getString(R.styleable.AutoButton_rightText);
        textSize = a.getDimension(R.styleable.AutoButton_btnTextSize,35);


        btnColor = a.getColor(R.styleable.AutoButton_btnColor,Color.GREEN);
        backColor = a.getColor(R.styleable.AutoButton_backColor,Color.WHITE);
        checkedTextColor = a.getColor(R.styleable.AutoButton_checkedTextColor,Color.WHITE);
        unCheckedTextColor = a.getColor(R.styleable.AutoButton_unCheckedTextColor,Color.BLACK);

        backStrokeColor = a.getColor(R.styleable.AutoButton_backStrokeColor,Color.BLACK);
        btnStrokeColor = a.getColor(R.styleable.AutoButton_btnStrokeColor,Color.BLACK);

        strokeWidth = a.getDimension(R.styleable.AutoButton_strokeWidth,1);
        roundRadius = a.getInteger(R.styleable.AutoButton_roundRadius,50);
